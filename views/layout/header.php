		...
		<div class="main-header nav navbar bg-body navbar-dark navbar-expand-xl py-6 py-xl-0">
			<div class="container-xxl container flex-nowrap">
				...
				<div class="d-none d-xl-flex w-xl-50">
					<ul class="navbar-nav">
						<li class="nav-item transition-all-xl-1 py-xl-11 py-0 me-xxl-10 me-xl-12 dropdown dropdown-hover dropdown-fullwidth">
							<a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-10px fs-xl-12px"
						...
						<li class="nav-item transition-all-xl-1 py-xl-11 py-0 me-xxl-10 me-xl-10">
							<a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-10px fs-xl-12px"
				...
				<div class="px-5 d-none d-xl-inline-block">
					...
					<div class="px-5 d-none d-xl-inline-block">
						...
						<?php else: ?>
							...
							<a href="<?= BASE_URL ?>?act=dang-xuat" class="lh-1 color-inherit text-decoration-none" style="margin:10px 0 10 0">
